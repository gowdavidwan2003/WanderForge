...
export const metadata = {
  ...
  description:
    'An AI travel planner that measures every journey against real road distances and driving times before it saves your itinerary, so a day it gives you is a day you can actually walk. Plan together in real time, split the bills, export to PDF or your calendar.',
  keywords:
    'travel planner, AI itinerary, trip planning, collaborative travel, travel time checker, budget travel',
  openGraph: {
    title: 'WanderForge — Trip plans that check their own work',
    description:
      'Every journey is measured against real road distances before the itinerary is saved. Plan together, split the bills, take it with you.',
    type: 'website',
